#
#  Be sure to run `pod spec lint KINWebBrowser.podspec' to ensure this is a
...
Pod::Spec.new do |s|
  ...
  # s.authors          = { "David Muir" => "david@kinwa.co", "other author" => "email@address.com" }
  # s.author           = 'David Muir', 'other author'
  # s.social_media_url = "http://twitter.com/David Muir"
